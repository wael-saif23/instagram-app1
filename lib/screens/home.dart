...
import 'package:insta_s_m_app/provider/post_provider.dart';
        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          return ListView(
            children: snapshot.data!.docs.map((DocumentSnapshot document) {
              ...
              return const UsersPostsContainer();
            }).toList(),
          );
        },
      )),
...
class UsersPostsContainer extends StatelessWidget {
  const UsersPostsContainer({super.key});

  @override
  Widget build(BuildContext context) {
    final allUsersDataFromDB = Provider.of<UserProvider>(context).getUser;
